...
int main(){
 ...
 /****** Input Readers atomic model instantiation *******************/
    const char * i_input_data_control = "../input_data/moore_input_test.txt";
    ...
    const char * i_input_data_trans_control = "../input_data/moore_input_test_transition.txt";
    shared_ptr<dynamic::modeling::model> input_trans_reader = dynamic::translate::make_dynamic_atomic_model<InputReader_Message_t, TIME, const char* >("input_trans_reader" , std::move(i_input_data_trans_control));



 /****** Moore atomic model instantiation *******************/
  shared_ptr<dynamic::modeling::model> state0 = dynamic::translate::make_dynamic_atomic_model<Moore, TIME>("state0", true,0,1,vector<pair<int,int>>{make_pair(0,1),make_pair(1,0)});
...
/*******TOP MODEL********/
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader, input_trans_reader, state0};
    ...
    dynamic::modeling::ICs ics_TOP = {
        ...
        dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,Moore_defs::transition_in>("input_trans_reader","state0"),        
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/ATOMIC_TEST_MOORE_outputs.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/ATOMIC_TEST_MOORE_state.txt");
    ...
    r.run_until(NDTime("00:45:00:000"));
    return 0;
